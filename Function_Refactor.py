...
# Images
X_IMAGE = pygame.transform.scale(pygame.image.load("image/x.jpg"), (150, 150))
O_IMAGE = pygame.transform.scale(pygame.image.load("image/o.svg.png"), (150, 150))
...
while True:
    ...
    ##Credit
    ## https://dev.to/ramakm/a-simple-python-tic-tac-toe-game-using-pygame-1l8b